...
class Profile extends My_Controller {
    ...
    private function _get_posted_data() {
        ...
        if ($this->input->post('user_type') == 'student') {
            ...
            if ($_FILES['father_photo']['name']) {
                ...
                if((!empty($width)) && $width > 120 || $height > 130){
                    error($this->lang->line('father_photo').':'.$this->lang->line('please_check_image_dimension'));  
                    redirect('profile');
                }
            ...
            if ($_FILES['mother_photo']['name']) {
                ...
                if((!empty($width)) && $width > 120 || $height > 130){
                    error($this->lang->line('mother_photo').':'.$this->lang->line('please_check_image_dimension'));  
                    redirect('profile');
                }
        ...
        if ($_FILES['photo']['name']) {
            ...
            if((!empty($width)) && $width > 120 || $height > 130){
                error($this->lang->line('please_check_image_dimension'));  
                redirect('profile');
            }
