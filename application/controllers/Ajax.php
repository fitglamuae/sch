...
class Ajax extends My_Controller {
    ...
    public function get_student_by_class() {
        ...
        if($bulk){
            $str = '<option value="">--' . $this->lang->line('all') . '--</option>';
        }else{
            $str = '<option value="">--' . $this->lang->line('select') . '--</option>';
        }
    ...
    public function get_student_by_section() {
        ...
        $students = $this->ajax->get_student_list_by_section($section_id, 'regular');
    ...
    public function get_user_list_by_type() {
        ...
        if (!empty($users)) {
            foreach ($users as $obj) {   
                $selected = $user_id == $obj->user_id ? $select : '';
                $str .= '<option value="' . $obj->user_id . '" ' . $selected . '>' . $obj->name .' [ '. $obj->department . ' ]</option>';
            }
        }
    ...
    public function get_lesson_by_subject() {
        ...
        $lessons = $this->ajax->get_lesson_by_subject($subject_id); 
