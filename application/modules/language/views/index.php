                ...
                <div class="" data-example-id="togglable-tabs">
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php if(has_permission(ADD, 'language', 'language') && !isset($labels)){ ?>
                            <li  class=""><a href="#tab_add_language"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>                          
                        <?php } ?>
                        ...
                        <?php if(isset($labels)){ ?>
                        <li  class="active"><a href="#tab_label" role="tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a></li>                          
                        <?php } ?>
                    </ul>
                    <br/>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="instructions"><strong><?php echo $this->lang->line('instruction'); ?>: </strong> 
                            <ol>
                                ...
                                <li>Please create a file here application/language/english/.</li>
                                <li>File name should be, same as your language which you created with adding _lang.php</li>
                               ...
                               <?php echo form_open(site_url('language/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="name"  id="name" placeholder=" <?php echo $this->lang->line('language_name'); ?>" required="required" type="text">
                               ...
                               <?php echo form_open(site_url('language/edit/'.$language), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <input  class="form-control col-md-7 col-xs-12"  name="name" value="<?php echo isset($language) ? $language : ''; ?>"  placeholder="<?php echo $this->lang->line('language_name'); ?>" required="required" type="text">
                                        <div class="text-info"><?php echo $this->lang->line('language_name_note'); ?></div>
                                        <div class="help-block"><?php echo form_error('name'); ?></div>
                                    </div>
                                </div>
