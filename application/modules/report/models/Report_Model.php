...
class Report_Model extends MY_Model {
    ...
    public function get_student_invoice_report($academic_year_id, $class_id, $user_id){
    ...
    public function get_student_due_fee_report($academic_year_id, $class_id, $user_id){
    ...
    public function get_student_fee_collection_report($academic_year_id, $class_id, $user_id, $date_from, $date_to){
    ...
    public function get_single_student($academic_year_id = null, $class_id = null, $section_id =null, $student_id = null){
        ...
        $this->db->select('E.roll_no, S.id, S.name, S.user_id, G.name as guardian_name, C.name as class_name');
        $this->db->from('enrollments AS E');        
        $this->db->join('students AS S', 'S.id = E.student_id', 'left');
