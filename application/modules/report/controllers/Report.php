    ...
    * ********************************************************** */
    public function sinvoice() {
        ...
        if ($_POST) {
            ...
            $this->data['sbalance'] = $this->report->get_student_invoice_report($academic_year_id, $class_id, $user_id);
    ...
    * ********************************************************** */
    public function duefee() {
        ...
        if ($_POST) {
            ...
            if($student_id){
               $this->data['student'] = $this->report->get_single_student($academic_year_id, $class_id, $section_id, $student_id);  
                $user_id = $this->data['student']->user_id;
            }            
                  
            $this->data['sbalance'] = $this->report->get_student_due_fee_report($academic_year_id, $class_id, $user_id);
    ...
    * ********************************************************** */
    public function feecollection() {
        ...
        if ($_POST) {
            ...
            $this->data['feecollection'] = $this->report->get_student_fee_collection_report($academic_year_id, $class_id, $user_id, $date_from, $date_to);
        }
