            ...
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                <tbody>
                    <tr>
                        ...
                        <td colspan="3"><?php echo $employee->name; ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><?php echo  $employee->resign_date ? date($this->gsms_setting->sms_date_format, strtotime($employee->resign_date)) : ''; ?></td>        
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td><?php echo $employee->status ? $this->lang->line('active') : $this->lang->line('in_active'); ?></td>                                           
                    </tr>
