...
class Employee_Model extends MY_Model {
    ...
    public function get_employee_list(){
        ...
        $this->db->select('E.*, U.email, U.role_id, D.name AS designation, DPT.title AS department');
    ...
    public function get_single_employee($id){
        ...
        $this->db->select('E.*, U.email, U.role_id, R.name AS role, D.name AS designation, SG.grade_name, DPT.title AS department');
        $this->db->from('employees AS E');
        $this->db->join('users AS U', 'U.id = E.user_id', 'left');
