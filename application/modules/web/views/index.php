            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="welcome-content">
                        ...
                        <p class="text">
                            <?php echo nl2br(strip_tags(substr($this->setting->about_text, 0, 500))); ?>...  
                        </p>
                        ...
                        <div class="single-event">
                            ...
                            <div class="content">
                                <a href="<?php echo site_url('event-detail/'.$obj->id); ?>">
                                    <h2 class="title"><?php echo nl2br(strip_tags(substr($obj->title, 0, 30))); ?>...</h2>
                                </a>
                                <p class="text">
                                    <?php echo nl2br(strip_tags(substr($obj->note, 0, 160))); ?>...  
                                </p>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="single-news">
                        ...
                        <div class="content">
                            ...
                            <p class="text">
                               <?php echo nl2br(strip_tags(substr($obj->news, 0, 160))); ?> ...
                            </p>
                            <div class="more-wrapper">
