...
<div class="page-contact-info-area">
                    ...
                    <div class="row">                  
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                                ...
                                <input  class="form-control col-md-7 col-xs-12"  name="name"  id="name" value="<?php echo isset($post['name']) ?  $post['name'] : ''; ?>" placeholder="" required="required" type="text" autocomplete="off">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                             <div class="item form-group">
                                ...
                                <input  class="form-control col-md-7 col-xs-12"  name="dob"  id="dob" value="<?php echo isset($post['dob']) ?  $post['dob'] : ''; ?>" placeholder="" required="required" type="text" autocomplete="off">
                    ...
                    <div class="row">                         
                        <div class="col-md-3 col-sm-3 col-xs-12">
                             <div class="item form-group">
                                  ...
                                  <input  class="form-control col-md-7 col-xs-12"  name="religion"  id="add_religion" value="<?php echo isset($post['religion']) ?  $post['religion'] : ''; ?>" placeholder="" type="text" autocomplete="off">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                             <div class="item form-group">
                                  ...
                                  <input  class="form-control col-md-7 col-xs-12"  name="caste"  id="add_caste" value="<?php echo isset($post['caste']) ?  $post['caste'] : ''; ?>" placeholder="" type="text" autocomplete="off">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                               ...
                               <input  class="form-control col-md-7 col-xs-12"  name="email"  id="email" value="<?php echo isset($post['email']) ?  $post['email'] : ''; ?>" placeholder="" type="email" required="required" autocomplete="off">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                             <div class="item form-group">
                                 ...
                                 <input  class="form-control col-md-7 col-xs-12"  name="phone"  id="phone" value="<?php echo isset($post['phone']) ?  $post['phone'] : ''; ?>" placeholder="" type="text" minlength="6" maxlength="20" autocomplete="off">
                    ...
                    <div class="row"> 
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                                ...
                                <input  class="form-control col-md-7 col-xs-12"  name="national_id"  id="national_id" value="<?php echo isset($post['national_id']) ?  $post['national_id'] : ''; ?>" placeholder="" type="text" autocomplete="off">
                           ...
                           <div class="col-md-3 col-sm-3 col-xs-12">
                               <div class="item form-group">
                                  ...
                                  <input  class="form-control col-md-7 col-xs-12"  name="health_condition"  id="health_condition" value="" placeholder="" type="text" autocomplete="off">
                    ...
                    <div class="row">                                      
                         ...
                         <div class="col-md-3 col-sm-3 col-xs-12">
                             <div class="item form-group">
                                ...
                                <input  class="form-control col-md-7 col-xs-12"  name="second_language"  id="second_language" value="<?php echo isset($post['second_language']) ?  $post['second_language'] : ''; ?>" placeholder="" type="text" autocomplete="off">
                     ...
                     <div class="row">  
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                               ...
                               <input  class="form-control col-md-7 col-xs-12"  name="father_name"  id="father_name" value="<?php echo isset($post['father_name']) ?  $post['father_name'] : ''; ?>" placeholder="" type="text" autocomplete="off">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                               ...
                               <input  class="form-control col-md-7 col-xs-12"  name="father_phone"  id="father_phone" value="<?php echo isset($post['father_phone']) ?  $post['father_phone'] : ''; ?>" placeholder=""  type="text" autocomplete="off">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                               ...
                               <input  class="form-control col-md-7 col-xs-12"  name="father_education"  id="father_education" value="<?php echo isset($post['father_education']) ?  $post['father_education'] : ''; ?>" placeholder=""  type="text" autocomplete="off">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                               ...
                               <input  class="form-control col-md-7 col-xs-12"  name="father_profession"  id="father_profession" value="<?php echo isset($post['father_profession']) ?  $post['father_profession'] : ''; ?>" placeholder=""  type="text" autocomplete="off">
                    ...
                    <div class="row"> 
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                               ...
                               <input  class="form-control col-md-7 col-xs-12"  name="father_designation"  id="father_designation" value="<?php echo isset($post['father_designation']) ?  $post['father_designation'] : ''; ?>" placeholder=""  type="text" autocomplete="off">
                    ...
                    <div class="row">  
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                               ...
                               <input  class="form-control col-md-7 col-xs-12"  name="mother_name"  id="mother_name" value="<?php echo isset($post['mother_name']) ?  $post['mother_name'] : ''; ?>" placeholder="" type="text" autocomplete="off">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                               ...
                               <input  class="form-control col-md-7 col-xs-12"  name="mother_phone"  id="mother_phone" value="<?php echo isset($post['mother_phone']) ?  $post['mother_phone'] : ''; ?>" placeholder=""  type="text" autocomplete="off">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                               ...
                               <input  class="form-control col-md-7 col-xs-12"  name="mother_education"  id="mother_education" value="<?php echo isset($post['mother_education']) ?  $post['mother_education'] : ''; ?>" placeholder=""  type="text" autocomplete="off">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                               ...
                               <input  class="form-control col-md-7 col-xs-12"  name="mother_profession"  id="mother_profession" value="<?php echo isset($post['mother_profession']) ?  $post['mother_profession'] : ''; ?>" placeholder=""  type="text" autocomplete="off">
                    ...
                    <div class="row"> 
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                               ...
                               <input  class="form-control col-md-7 col-xs-12"  name="mother_designation"  id="mother_designation" value="<?php echo isset($post['mother_designation']) ?  $post['mother_designation'] : ''; ?>" placeholder=""  type="text" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                                ...
                                <input  class="form-control col-md-7 col-xs-12"  name="gud_phone"  id="gud_phone" value="<?php echo isset($post['gud_phone']) ?  $post['gud_phone'] : ''; ?>" placeholder="" required="required" type="text" autocomplete="off">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                                ...
                                <input  class="form-control col-md-7 col-xs-12"  name="gud_relation"  id="relation_with" value="<?php echo isset($post['gud_relation']) ?  $post['gud_relation'] : ''; ?>" placeholder="" type="text" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                                ...
                                <input  class="form-control col-md-7 col-xs-12"  name="gud_name"  id="gud_name" value="<?php echo isset($post['gud_name']) ?  $post['gud_name'] : ''; ?>" placeholder="" required="required" type="text" autocomplete="off">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                                ...
                                <input  class="form-control col-md-7 col-xs-12"  name="gud_email"  id="gud_email" value="<?php echo isset($post['gud_email']) ?  $post['gud_email'] : ''; ?>" placeholder="" required="required" type="text" autocomplete="off">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                                ...
                                <input  class="form-control col-md-7 col-xs-12"  name="gud_national_id"  id="gud_national_id" value="<?php echo isset($post['gud_national_id']) ?  $post['gud_national_id'] : ''; ?>" placeholder="" type="text" autocomplete="off">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                                ...
                                <input  class="form-control col-md-7 col-xs-12"  name="gud_profession"  id="gud_profession" value="<?php echo isset($post['gud_profession']) ?  $post['gud_profession'] : ''; ?>" placeholder="" type="text" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                                ...
                                <input  class="form-control col-md-7 col-xs-12"  name="gud_religion"  id="gud_religion" value="<?php echo isset($post['gud_religion']) ?  $post['gud_religion'] : ''; ?>" placeholder="" type="text" autocomplete="off">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                                ...
                                <input  class="form-control col-md-7 col-xs-12"  name="gud_other_info"  id="gud_other_info" value="<?php echo isset($post['gud_religion']) ?  $post['gud_religion'] : ''; ?>" placeholder="" type="text" autocomplete="off">
                    ...
                    <div class="row">    
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="item form-group">
                                ...
                                <textarea  class="form-control col-md-7 col-xs-12 textarea-4column"  name="gud_present_address"  id="gud_present_address"  placeholder=""><?php echo isset($post['gud_present_address']) ?  $post['gud_present_address'] : ''; ?></textarea>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="item form-group">
                                ...
                                <textarea  class="form-control col-md-7 col-xs-12 textarea-4column"  name="gud_permanent_address"  id="gud_permanent_address"  placeholder=""><?php echo isset($post['gud_permanent_address']) ?  $post['gud_permanent_address'] : ''; ?></textarea>
                    ...
                    <div class="row"> 
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-12">
                           <div class="item form-group">
                               <label for="present_address"><?php echo $this->lang->line('present_address'); ?> </label>
                                <textarea  class="form-control col-md-7 col-xs-12 textarea-4column"  name="present_address"  id="present_address"  placeholder=""><?php echo isset($post['present_address']) ?  $post['present_address'] : ''; ?></textarea>
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-12">
                           <div class="item form-group">
                              ...
                              <textarea  class="form-control col-md-7 col-xs-12 textarea-4column"  name="permanent_address"  id="permanent_address"  placeholder=""><?php echo isset($post['permanent_address']) ?  $post['permanent_address'] : ''; ?></textarea>
                      ...
                      <div class="row"> 
                        <div class="col-md-3 col-sm-3 col-xs-12">
                             <div class="item form-group">
                                ...
                                <input  class="form-control col-md-7 col-xs-12"  name="previous_school"  id="previous_school" value="<?php echo isset($post['previous_school']) ?  $post['previous_school'] : ''; ?>" placeholder=""  type="text" autocomplete="off">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                             <div class="item form-group">
                                ...
                                <input  class="form-control col-md-7 col-xs-12"  name="previous_class"  id="previous_class" value="<?php echo isset($post['previous_class']) ?  $post['previous_class'] : ''; ?>" placeholder=""  type="text" autocomplete="off">
 ...
 <script type="text/javascript">     
    ...
    $('#dob').datepicker({ startView: 2, endDate: "currentDate"});
    $('#admission').validate();
