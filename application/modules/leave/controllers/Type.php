...
class Type extends MY_Controller {
    ...
    * ********************************************************** */
    private function _prepare_type_validation() {
        ...
        $this->form_validation->set_rules('total_leave', $this->lang->line('total_leave'), 'trim|required|greater_than[0]');
        $this->form_validation->set_rules('type', $this->lang->line('leave_type'), 'trim|required|alpha_numeric_spaces|callback_type');
    }
