...
class Approve extends MY_Controller {
    ...
    * ********************************************************** */
    private function _prepare_approve_validation() {
        ...
        $this->form_validation->set_rules('leave_note', $this->lang->line('note'), 'trim');
    }
    ...
    * ********************************************************** */
    private function _get_posted_approve_data() {
        ...
        $used = get_total_used_leave($role_id, $leave_type_id, $user_id);
        $leave_type = $this->approve->get_single('leave_types', array('id'=>$leave_type_id, 'role_id'=>$role_id));  
