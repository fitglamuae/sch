                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('leave/type/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="total_leave"  id="total_leave" value="<?php echo isset($post['total_leave']) ?  $post['total_leave'] : ''; ?>" placeholder="<?php echo $this->lang->line('total_leave'); ?>" min="1" required="required" type="number" autocomplete="off">
                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('leave/type/edit/'.$type->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="total_leave"><?php echo $this->lang->line('total_leave'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">                                        
                                        <input  class="form-control col-md-7 col-xs-12"  name="total_leave" value="<?php echo isset($type) ? $type->total_leave : ''; ?>"  placeholder="<?php echo $this->lang->line('total_leave'); ?>" min="1" required="required" type="number" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('total_leave'); ?></div>
                                    </div>
                                </div> 
