                        ...
                        <div class="tab-pane fade in active" id="tab_edit_income">
                            ...
                            <!-- For cheque End-->
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="amount"  id="amount" value="<?php echo isset($income->net_amount) ?  $income->net_amount : ''; ?>" placeholder="<?php echo $this->lang->line('amount'); ?>" min="1" required="required" type="number" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('amount'); ?></div>
                                    </div>
                                </div>
