                               ...
                               <?php echo form_open_multipart(site_url('accounting/duefeeemail/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-12 col-xs-12_"  name="role_id"  id="role_id" required="required" onchange="get_user_by_role(this.value);">
                                ...
                                <div class="item form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-12 col-xs-12_"  name="class_id"  id="class_id" required="required" onchange="get_user(this.value);">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>  
