<section class="content invoice profile_img layout-box">
      ...
      <div class="row invoice-info">          
          <div class="col-md-6 col-sm-6 col-xs-6 invoice-col_"> 
                <strong><?php echo $this->lang->line('student'); ?>:</strong> <?php echo $invoice->user_name; ?>
          ...
          <div class="col-md-6 col-sm-6 col-xs-6 invoice-col">             
                ...
                <br><strong><?php echo $this->lang->line('date'); ?>:</strong> <?php echo date($settings->sms_date_format, strtotime($invoice->date)); ?>
          </div>
          <!-- /.col -->
      </div>   
