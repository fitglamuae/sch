<div class="row">
                        ...
                        <div class="x_content"> 
                           <?php echo form_open(site_url('accounting/payment/paid/'.$invoice_id), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                            ...
                            <div class="display fn_sslcommerz"  style="<?php if(isset($post) && $post['payment_method'] == 'sslcommerz'){ echo 'display:block;';} ?>">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="ssl_postcode"><?php echo $this->lang->line('post_code'); ?> <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="ssl_postcode"  id="ssl_postcode" value="" placeholder="<?php echo $this->lang->line('post_code'); ?>"  type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('ssl_postcode'); ?></div>
                                    </div>
                                </div>
                                <div class="item form-group">
 ...
 <script type="text/javascript">
    ...
    function check_payment_method(payment_method) {
        ...
        $('#ssl_postcode').prop('required', false); 
        ...
        if (payment_method == "cheque") {  
            ...
            $('#ssl_postcode').prop('required', true); 
