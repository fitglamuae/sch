...
class Duefeeemailsms_Model extends MY_Model {
    ...
    public function get_user_list( $receiver_id, $class_id = null){
        ...
        $this->db->select('E.student_id, S.phone, S.name, S.guardian_id, S.user_id, U.email, U.role_id,  U.id,  C.name AS class_name');
    ...
    public function get_due_fee($user_id, $class_id){
