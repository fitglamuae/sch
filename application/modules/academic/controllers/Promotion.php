...
class Promotion extends MY_Controller {
    ...
    public function index() {                
        ...
        if($_POST){
            ...
            $this->data['next_class_sections'] = $this->promotion->get_list('sections', array('class_id' => $next_class_id, 'status'=>1), '', '', '', 'id', 'ASC');
            $this->data['current_class_sections'] = $this->promotion->get_list('sections', array('class_id' => $current_class_id, 'status'=>1), '', '', '', 'id', 'ASC');
