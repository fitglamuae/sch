...
class Subject extends MY_Controller {
    ...
    * ********************************************************** */
    private function _prepare_subject_validation() {
        ...
        $this->form_validation->set_rules('author', $this->lang->line('author'), 'trim|alpha_numeric_spaces');   
        $this->form_validation->set_rules('note', $this->lang->line('note'), 'trim');   
        $this->form_validation->set_rules('name', $this->lang->line('name'), 'required|trim|alpha_numeric_spaces|callback_name');
    }
