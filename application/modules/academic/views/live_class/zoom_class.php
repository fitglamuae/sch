...
<html lang="en">
    <head>  
        ...
        <script type="text/javascript" src="https://source.zoom.us/2.4.0/lib/webim.min.js"></script>
        <script type="text/javascript" src="https://source.zoom.us/2.4.0/lib/av/1501_js_media.min.js"></script>
    </head>
    ...
    <body class="nav-md">      
        ...
        <script type="text/javascript">
            ...
            var meetConfig = {
                apiKey: "<?php echo $this->gsms_setting->zoom_api_key; ?>",
                apiSecret: "<?php echo $this->gsms_setting->zoom_secret; ?>",
