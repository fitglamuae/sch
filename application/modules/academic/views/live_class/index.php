                                        ...
                                        <?php $count = 1; if(isset($live_classes) && !empty($live_classes)){ ?>
                                            ...
                                            <tr>
                                                ...
                                                <td> 
                                                    ...
                                                    <select  class="form-control col-md-7 col-xs-12"  name="class_status"  id="class_status" onchange="update_class_status('<?php echo $obj->id; ?>', this.value);" style="height: 24px;margin-right: 8px;">
                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('academic/liveclass/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 "  name="class_type" id="add_class_type" required="required" onchange="set_live_class_type(this.value, 'add');">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                         
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12 chk-label" style="padding-top: 0px;" for="send_notification"><?php echo $this->lang->line('send_notification'); ?></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('academic/liveclass/edit/'.$live_class->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="class_type"><?php echo $this->lang->line('live_class_type'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12"  name="class_type" id="add_class_type" required="required" onchange="set_live_class_type(this.value, 'edit');">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>    
                                            <?php $types = get_live_class_types(); ?>
                                            <?php foreach($types as $key=>$value){ ?>
