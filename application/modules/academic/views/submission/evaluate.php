				    ...
				    <?php $guardian_access_std_data = get_guardian_access_data('student'); ?> 
                                    <?php $count = 1; if(isset($submissions) && !empty($submissions)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select  class="form-control col-md-7 col-xs-12 status-type  "  name="evaluation_status"  id="evaluation_status" onchange="update_evatioation_status('<?php echo $obj->id; ?>', this.value);" style="height: 23px;margin-right: 10px;">
