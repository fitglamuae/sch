                                    ...
                                    <?php $count = 1; if(isset($submissions) && !empty($submissions)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo date($this->gsms_setting->sms_date_format, strtotime($obj->submitted_at)); ?></td>
                                              <?php if($this->session->userdata('role_id') == TEACHER || $this->session->userdata('role_id') == SUPER_ADMIN || $this->session->userdata('role_id') == ADMIN){ ?>    
                                                <td>
                                                   <select  class="form-control col-md-7 col-xs-12 status-type "  name="evaluation_status"  id="evaluation_status" onchange="update_evatioation_status('<?php echo $obj->id; ?>', this.value);">
