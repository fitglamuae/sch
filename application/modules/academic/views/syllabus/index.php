                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('academic/syllabus/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12  "  name="class_id"  id="class_id" required="required" onchange="get_subject_by_class(this.value, '', 'add');" >
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('academic/syllabus/edit/'.$syllabus->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12  "  name="class_id"  id="class_id" required="required" onchange="get_subject_by_class(this.value, '', 'edit');">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                            <?php foreach($classes as $obj ){ ?>
                                            <?php
                                                if($this->session->userdata('role_id') == TEACHER){
