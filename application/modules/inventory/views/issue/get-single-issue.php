<table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
    <tbody>
        ...
        <tr>
            <th width="20%"> <?php echo $this->lang->line('product'); ?></th>
        ...
        <tr>
            ...
            <td><?php echo date($this->gsms_setting->sms_date_format, strtotime($issue->due_date)); ?></td>      
        </tr>
        ...
        <tr>
            ...
            <td>
                ...
                if($issue->return_date){
                    echo date($this->gsms_setting->sms_date_format, strtotime($issue->return_date));
                }else{ 
