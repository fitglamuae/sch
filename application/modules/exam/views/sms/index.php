                ...
                <div class="" data-example-id="togglable-tabs">                    
                    ...
                    <div class="tab-content"> 
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_send_sms">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('exam/text/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">  
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <select  class="form-control col-md-12 col-xs-12_"  name="sms_gateway"  id="sms_gateway" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>  
