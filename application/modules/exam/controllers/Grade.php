...
class Grade extends MY_Controller {
    ...
    * ********************************************************** */
    private function _prepare_grade_validation() {
        ...
        $this->form_validation->set_rules('name', $this->lang->line('exam_grade'), 'trim|required|alpha_numeric_spaces|callback_name');
        $this->form_validation->set_rules('point', $this->lang->line('grade_point'), 'trim|required|callback_point');
        $this->form_validation->set_rules('mark_from', $this->lang->line('mark_from'), 'trim|required|required|greater_than[0]');
        $this->form_validation->set_rules('mark_to', $this->lang->line('mark_to'), 'trim|required|required|greater_than[0]');
