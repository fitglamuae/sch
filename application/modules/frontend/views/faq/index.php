            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php if(has_permission(ADD, 'frontend', 'faq')){ ?>
                    ...
                    <div class="tab-content">
                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($faqs) && !empty($faqs)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(has_permission(EDIT, 'frontend', 'faq')){ ?>
                                                    <a href="<?php echo site_url('frontend/faq/edit/'.$obj->id); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a>
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'frontend', 'faq')){ ?>
                                                    <a href="<?php echo site_url('frontend/faq/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_faq">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('frontend/faq/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                 ...
                                 <div class="item form-group">
                                       <label class="control-label col-md-3 col-sm-3 col-xs-12" for="description"> <?php echo $this->lang->line('description'); ?> <span class="required">*</span></label>
                                         <div class="col-md-6 col-sm- col-xs-12">
                                             <textarea  class="form-control col-md-7 col-xs-12"  name="description"  id="description" required="required" placeholder="<?php echo $this->lang->line('description'); ?>"><?php echo isset($description) ?  $description : ''; ?></textarea>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <a href="<?php echo site_url('frontend/faq/index'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_faq">
                            <div class="x_content">
                                 ...
                                 <?php echo form_open(site_url('frontend/faq/edit/'.$faq->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                 ...
                                 <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="description"> <?php echo $this->lang->line('description'); ?> <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <textarea  class="form-control col-md-7 col-xs-12"  name="description"  id="description" required="required" placeholder="<?php echo $this->lang->line('description'); ?>"><?php echo isset($faq) ? $faq->description : ''; ?></textarea>
                                             <div class="help-block"><?php echo form_error('description'); ?></div>
                                       </div>
                                 </div>
