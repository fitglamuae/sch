...
class Receive extends MY_Controller {
    ...
    * ********************************************************** */
    private function _prepare_receive_validation() {
        ...
        $this->form_validation->set_rules('from_title', $this->lang->line('from_title'), 'trim|required|alpha_numeric_spaces');
        ...
        $this->form_validation->set_rules('to_title', $this->lang->line('to_title'), 'trim|required|alpha_numeric_spaces');
