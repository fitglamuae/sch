                         ...
                         <div class="tab-pane fade in active"id="tab_setting">
                            <div class="x_content"> 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="phone"  id="phone" value="<?php echo isset($setting) ? $setting->phone : ''; ?>" placeholder="<?php echo $this->lang->line('phone'); ?> " required="required" type="number" minlength="6" maxlength="20" plete="off">
                                ...
                                <div class="row">                                    
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="registration_date"  id="registration_date" value="<?php echo isset($setting) ? date('d-m-Y', strtotime($setting->registration_date)) : ''; ?>" placeholder="<?php echo $this->lang->line('registration_date'); ?> " required="required" type="text" autocomplete="off">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="email"  id="email" value="<?php echo isset($setting) ? $setting->email : ''; ?>" placeholder="<?php echo $this->lang->line('email'); ?> " required="email" type="email" autocomplete="off">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="school_fax"  id="school_fax" value="<?php echo isset($setting) ? $setting->school_fax : ''; ?>" placeholder="<?php echo $this->lang->line('school_fax'); ?>" minlength="4" maxlength="20" type="text" autocomplete="off">
                                ...
                                <div class="row">                                    
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="currency"  id="currency" value="<?php echo isset($setting) ? $setting->currency : ''; ?>" placeholder="<?php echo $this->lang->line('currency'); ?> " required="required" minlength="1" maxlength="3" type="text" autocomplete="off">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="currency_symbol"  id="currency_symbol" value="<?php echo isset($setting) ? $setting->currency_symbol : ''; ?>" placeholder="<?php echo $this->lang->line('currency_symbol'); ?> " required="required" minlength="1" maxlength="3" type="text" autocomplete="off">
                               ...
                               <div class="row">                             
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="brand_logo"><?php echo $this->lang->line('brand_logo'); ?></label>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="front_logo"><?php echo $this->lang->line('frontend_logo'); ?></label>
                                            <div class="btn btn-default btn-file"><i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="favicon_icon"><?php echo $this->lang->line('favicon_icon'); ?></label>
                                            <div class="btn btn-default btn-file"><i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?>
...
<link href="<?php echo VENDOR_URL; ?>datepicker/datepicker.css" rel="stylesheet">
 ...
 <script type="text/javascript">
  ...
  $('#registration_date').datepicker({endDate: "today"});
  $("#setting").validate();  
</script>