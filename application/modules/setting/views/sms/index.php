                          ...
                          <div class="tab-pane fade in <?php echo isset($twilio) ? 'active':''; ?>" id="tab_twilio_setting">
                             <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="twilio_account_sid" value="<?php echo isset($setting) ? $setting->twilio_account_sid : ''; ?>"  placeholder="account_sid" required="required" type="text">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="twilio_auth_token" value="<?php echo isset($setting) ? $setting->twilio_auth_token : ''; ?>"  placeholder="auth_token" required="required" type="text">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="twilio_from_number" value="<?php echo isset($setting) ? $setting->twilio_from_number : ''; ?>"  placeholder="from_number" required="required" type="text">
