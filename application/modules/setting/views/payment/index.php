            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    <ul  class="nav nav-tabs bordered">                     
                        ...
                        <li  class="<?php echo isset($ccavenue) || isset($midtrans) || isset($flutter) || isset($ipay) ? 'active':''; ?> dropdown">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade in <?php echo isset($dbbl) ? 'active':''; ?>" id="tab_dbbl_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="dbbl_extra_charge" id="dbbl_extra_charge" value="<?php echo isset($setting) ? $setting->dbbl_extra_charge : ''; ?>"  placeholder="<?php echo $this->lang->line('extra_charge'); ?>" type="number" autocomplete="off">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 "  name="dbbl_status" id="dbbl_status" required="required">
                        ...
                        <div class="tab-pane fade in <?php echo isset($stripe) ? 'active':''; ?> display" id="tab_stripe_setting">
                           <div class="x_content"> 
                              ...
                              <div class="item form-group">
                                  ...
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                      <input  class="form-control col-md-7 col-xs-12"  name="stripe_extra_charge" value="<?php echo isset($setting) ? $setting->stripe_extra_charge : ''; ?>"  placeholder="<?php echo $this->lang->line('extra_charge'); ?>" type="number" autocomplete="off">
                        ...
                        <div class="tab-pane fade in <?php echo isset($ccavenue) ? 'active':''; ?> display" id="tab_ccavenue_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="cca_extra_charge" value="<?php echo isset($setting) ? $setting->cca_extra_charge : ''; ?>"  placeholder="<?php echo $this->lang->line('extra_charge'); ?>"  type="number" autocomplete="off">
                         ...
                         <div class="tab-pane fade in <?php echo isset($jazzcash) ? 'active':''; ?>" id="tab_jazzcash_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="jaz_extra_charge" id="stack_extra_charge" value="<?php echo isset($setting) ? $setting->jaz_extra_charge : ''; ?>"  placeholder="<?php echo $this->lang->line('extra_charge'); ?>" type="number" autocomplete="off">
                        ...
                        <div class="tab-pane fade in <?php echo isset($sslcommerz) ? 'active':''; ?>" id="tab_sslcommerz_setting">
                            <div class="x_content"> 
                                ...
                                <input type="hidden" value="<?php echo isset($setting) ? $setting->id : ''; ?>" name="id" />
                                <input type="hidden" value="1" name="sslcommerz" />
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="ssl_extra_charge" id="ssl_extra_charge" value="<?php echo isset($setting) ? $setting->ssl_extra_charge : ''; ?>"  placeholder="<?php echo $this->lang->line('extra_charge'); ?>" type="number" autocomplete="off">
                         ...
                         <div class="tab-pane fade in <?php echo isset($midtrans) ? 'active':''; ?>" id="tab_midtrans_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="mid_extra_charge" id="mid_extra_charge" value="<?php echo isset($setting) ? $setting->mid_extra_charge : ''; ?>"  placeholder="<?php echo $this->lang->line('extra_charge'); ?>" type="number" autocomplete="off">
                        ...
                        <div class="tab-pane fade in <?php echo isset($instamojo) ? 'active':''; ?>" id="tab_instamojo_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="mojo_extra_charge" id="ssl_extra_charge" value="<?php echo isset($setting) ? $setting->mojo_extra_charge : ''; ?>"  placeholder="<?php echo $this->lang->line('extra_charge'); ?>" type="number" autocomplete="off">
                         ...
                         <div class="tab-pane fade in <?php echo isset($flutter) ? 'active':''; ?>" id="tab_flutter_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="flut_extra_charge" id="flut_extra_charge" value="<?php echo isset($setting) ? $setting->flut_extra_charge : ''; ?>"  placeholder="<?php echo $this->lang->line('extra_charge'); ?>" type="number" autocomplete="off">
                         ...
                         <div class="tab-pane fade in <?php echo isset($ipay) ? 'active':''; ?>" id="tab_ipay_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="ipay_extra_charge" id="flut_extra_charge" value="<?php echo isset($setting) ? $setting->ipay_extra_charge : ''; ?>"  placeholder="<?php echo $this->lang->line('extra_charge'); ?>" type="number" autocomplete="off">
