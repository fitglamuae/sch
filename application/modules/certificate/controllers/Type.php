...
class Type extends MY_Controller {
    ...
    * ********************************************************** */
    private function _prepare_type_validation() {
        ...
        $this->form_validation->set_rules('name', $this->lang->line('certificate_name'), 'trim|required|alpha_numeric_spaces|callback_name');
        $this->form_validation->set_rules('top_title', $this->lang->line('school_name'), 'trim|alpha_numeric_spaces|required');        
        $this->form_validation->set_rules('main_text', $this->lang->line('main_certificate_text'), 'trim|required');        
        $this->form_validation->set_rules('footer_left', $this->lang->line('footer_left'), 'trim|alpha_numeric_spaces');
        $this->form_validation->set_rules('footer_middle', $this->lang->line('footer_middle'), 'trim|alpha_numeric_spaces');
        $this->form_validation->set_rules('footer_right', $this->lang->line('footer_right'), 'trim|alpha_numeric_spaces');
