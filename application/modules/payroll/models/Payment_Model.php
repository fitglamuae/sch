...
class Payment_Model extends MY_Model {
    ...
    public function get_single_payment_user($role_id, $user_id) {
        ...
        if ($role_id == TEACHER) {
            ...
            $this->db->select('T.*, D.title AS department, SG.*, U.email, U.role_id, U.status AS login_status ');
    ...
    public function get_payment_list($user_id, $payment_to){
         ...
         if ($payment_to == 'employee') {
            ...
            $this->db->select('SP.*, SG.grade_name, T.name, T.photo,  D.title AS department, U.email, U.role_id, U.status AS login_status ');
            $this->db->from('salary_payments AS SP');
