<div class="" data-example-id="togglable-tabs">
    <ul  class="nav nav-tabs bordered no-print">
        <li class="active"><a href="#tab_guardian"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-info-circle"></i> <?php echo $this->lang->line('guardian_information'); ?></a> </li>
            ...
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                <tbody>                    
                    ...
                    <tr>
                        ...
                        <td><?php echo $guardian->status ? $this->lang->line('active') : $this->lang->line('in_active'); ?></td> 
                    </tr>
                </tbody>
            </table>
        </div>
        
         <div  class="tab-pane fade in no-print" id="tab_student_list" >
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                <thead>
                   <tr>
          ...
          <div  class="tab-pane fade in no-print" id="tab_invoice_list" >
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th><?php echo $this->lang->line('sl_no'); ?></th>
