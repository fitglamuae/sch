                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_activity">
                            <div class="x_content"> 
                               ...
                               <div class="form-group"> 
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="activity"><?php echo $this->lang->line('activity'); ?> <span class="required"> *</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control col-md-7 col-xs-12"  name="activity"  id="activity" required="required"  placeholder="<?php echo $this->lang->line('activity'); ?>"><?php echo isset($post['activity']) ?  $post['activity'] : ''; ?></textarea>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('student/activity/edit/'.$activity->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="activity"><?php echo $this->lang->line('activity'); ?> <span class="required"> *</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control col-md-7 col-xs-12"  name="activity"  id="activity" required="required" placeholder="<?php echo $this->lang->line('activity'); ?>"><?php echo isset($activity->activity) ?  $activity->activity : ''; ?></textarea>
                                        <div class="help-block"><?php echo form_error('activity'); ?></div>
                                    </div>
                                </div>
