                               ...
                               <div class="row">
                                   ...
                                   <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select  class="form-control col-md-7 col-xs-12 "  name="department_id"  id="department_id" disabled="disabled">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="phone"  id="phone" value="<?php echo isset($profile->phone) ?  $profile->phone : ''; ?>" placeholder="<?php echo $this->lang->line('phone'); ?>" required="required" minlength="6" maxlength="20" type="text">
                                ...
                                <div class="row"> 
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <div  class="form-control col-md-7 col-xs-12"><?php echo isset($profile->joining_date) ?  date('d-m-Y', strtotime($profile->joining_date)) : $post['joining_date']; ?></div>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <input type="hidden" name="prev_resume" id="prev_resume" value="<?php echo $profile->resume; ?>" />
                                             <?php if($profile->resume){ ?>
                                            <br><a target="_blank" href="<?php echo UPLOAD_PATH; ?>/teacher-resume/<?php echo $profile->resume; ?>" class="btn btn-success btn-xs"><i class="fa fa-download"></i><?php echo $this->lang->line('download'); ?></a> 
                                             <?php } ?>                                     
