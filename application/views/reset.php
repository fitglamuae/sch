...
<html lang="en">
    <head>
        ...
        <title><?php echo $this->lang->line('reset_password'). ' | ' . $this->gsms_setting->school_name;  ?></title>
            ...
            <div class="form login_form">
                ...
                <section class="login_content">                    
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                        <input type="password" name="password" required="required" minlength="6" maxlength="20" class="form-control has-feedback-left" placeholder="<?php echo $this->lang->line('password'); ?>">
