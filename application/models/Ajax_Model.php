...
class Ajax_Model extends MY_Model {
    ...
    public function get_student_list_by_section($section_id = null, $status_type = null){
    ...
    public function get_user_list($type) {
        ...
        if ($type == 'teacher') {
            ...
            $this->db->select('T.name, T.user_id, D.title AS department, SG.grade_name, U.email, U.role_id');
    ...
    public function get_lesson_by_subject($subject_id){
